...
‘select’ vs ‘pull’: ‘pull’ takes something from data frame, ‘select’ can
be used to rename a variable
...
this is used to add or change variables. creating new variables that
exist within data frame. can modify and override variables in df.
